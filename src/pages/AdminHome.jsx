          ...
          <div className="flex-grow">
            ...
            <div className="p-4">
              <ul className="space-y-1">
                <li>
                  <a onClick={()=> buttonClick(1)} href="javascript:void(0)" className="flex items-center hover:bg-yellow-400 rounded-xl font-bold text-sm hover:text-yellow-900 py-3 px-4">
                ...
                <li>
                  <a onClick={()=> buttonClick(2)} href="javascript:void(0)" className="flex bg-white hover:bg-yellow-400 hover:text-yellow-900 rounded-xl font-bold text-sm text-gray-900 py-3 px-4">
                    <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" className="text-lg mr-4" viewBox="0 0 16 16">
